...
x1 = (-hard_svm_model.intercept_ - hard_svm_model.coef_[0][0] * x0) / hard_svm_model.coef_[0][1]
x2 = (-soft_svm_model.intercept_ - soft_svm_model.coef_[0][0] * x0) / soft_svm_model.coef_[0][1]
