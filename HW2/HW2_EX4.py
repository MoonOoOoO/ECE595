...
def a_i_ii():
    ...
    plt.tight_layout()
    plt.savefig("screenshot/4.png", transparent=True, pad_inches=0)
    plt.show()
...
def c_i():
    ...
    plt.tight_layout()
    plt.savefig("screenshot/55.png", transparent=True, pad_inches=0)
    plt.show()
...
def c_ii():
    ...
    plt.tight_layout()
    plt.savefig("screenshot/8.png", transparent=True, pad_inches=0)
    # plt.figure(2, figsize=(6, 2.7))
    plt.figure(figsize=(6, 8))
    plt.subplot(311)
    ...
    plt.tight_layout()
    plt.savefig("screenshot/66.png", transparent=True, pad_inches=0)
    plt.show()
